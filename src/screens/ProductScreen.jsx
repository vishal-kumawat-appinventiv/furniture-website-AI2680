          ...
          <div className="productDesc flex flex-col gap-2">
            ...
            <div className="relative mt-2 p-3 border-[0.5px] border-gray-200 rounded">
              <div className="absolute top-[-19%] left-1/2 transform -translate-x-1/2 bg-white px-2 py-1">
                <h4 className="text-center font-bold text-gray-600 text-sm">Guaranteed Safe Checkout</h4>
              </div>
            ...
            <div className="flex gap-2">
              ...
              <p className="text-gray-600">No-Risk Money Back Guarantee!</p>
            </div>
            <div className="flex gap-2">
              <svg
                className="w-5 h-5"
              ...
              <p className="text-gray-600">No Hassle Refunds</p>
            </div>
            <div className="flex gap-2">
              <svg
                className="w-5 h-5"
